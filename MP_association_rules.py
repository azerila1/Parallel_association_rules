...
# This module a modified version of the association_rules from mlxtend toolkit for parallel computing
...
def association_rules_MP(subset, main_set,
                         metric="confidence",
                         min_threshold=0.8,
                         support_only=False):
    ...
    # # # # # # # # # # # # # # # # # # # # # # # added section on 23.10.2018: Alireza Ranjbar
    # # # # # # # # #  for Parallel computring
    keys_SUBSET = subset['itemsets'].values
    values_SUBSET = subset['support'].values
    frequent_items_dict_SUBSET = dict(zip(frozenset_vect(keys_SUBSET), values_SUBSET))
    # # # # # # # # # # # # # # ## # # # # # # # # # # # # # # # # # # # # # # # #
    ...
    # # # # # # # # # modified loops for computation on the subset against the main_set
    for k in frequent_items_dict_SUBSET.keys():
